...
- [ ] **3.1: Create New Release Script File**
    - **Action:** Create a new script at `scripts/release.mjs` to house the new release logic.

- [ ] **3.2: Implement Release Logic with Auto-Branching**
